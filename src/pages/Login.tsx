      ...
      >
        ...
        <div className="hidden md:flex md:w-1/2 bg-slate-100 dark:bg-slate-700 items-center justify-center p-12 relative overflow-hidden">
          <div className="relative z-10 text-center">
            ...
            <h1 className="text-3xl font-bold text-[#1a2b4c] dark:text-white mb-4">Chào mừng bạn tới Carevia</h1>
            <p className="text-slate-500 dark:text-slate-400 text-lg font-medium">Nơi thú cưng của bạn được chăm sóc như gia đình.</p>
          </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Đăng nhập tài khoản</h2>
